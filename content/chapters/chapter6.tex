...
% something about the black unit?? if not, remove this from figure.
...
Finally, \textbf{Fig. \ref{vgg:deepvis-block1}} once again confirms that the lower layers look for the more fundamental features. % si noe mer om dette?
