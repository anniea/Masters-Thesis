...
For every architecture configuration described in section \ref{case-networks}, a network was created, trained and tested. The performance results of each network is displayed in \textbf{Table \ref{tab:case-results}}, with loss and accuracy for the validation and test sets. The values represent the average result each network achieved on the respective sets. For the extra output architectures, these performance measures show the combined metric results, i.e. the performance based on the concatenated output. For discrete metric results, with identification and expression classification performance separately, see \textbf{Table \ref{tab:case-results-id}} and \textbf{Table \ref{tab:case-results-exp}}.
...
G & 0.72233 & 0.70622 & 3.69950 & 3.73781 \\ \hline
H & 0.73064 & 0.71220 & 3.54001 & 3.56324 \\ \hline
I & 0.69890 & 0.68927 & 3.65174 & 3.65291 \\ \hline
\end{tabular}
\end{center}
\caption[Performance of case study networks]{Performance of case study networks. Describe results a bit. Networks were trained as described in section \ref{case-training}}
...
\end{tabular}
\end{center}
\caption[Identification performance of extra output case study networks]{Identification performance of extra output case study networks. Describe a bit more. Combined metric performance can be seen in \textbf{Table \ref{tab:case-results}}}
...
\end{tabular}
\end{center}
\caption[Expression performance of extra output case study networks]{Expression performance of extra output case study networks. Describe a bit more. Combined metric performance can be seen in \textbf{Table \ref{tab:case-results}}}
