...
\end{tabular}
\caption[Deconvolutional results for MNIST pool layer]{Visualizations produced using a deconvolutional network for the visualization input image in \textbf{a}. A selection of four different feature maps (F.m.) from the \texttt{pool} layer is displayed.}
\label{mnist:deconv}
\end{center}
\end{figure}
