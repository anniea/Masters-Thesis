...
\begin{center}
\begin{tabular}{ccccc}
\subfloat['0': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test0.png}} & 
\subfloat['1': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test1.png}} & 
\subfloat['2': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test2.png}} &
\subfloat['3': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test3.png}} & 
\subfloat['4': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test4.png}} \\
\subfloat['2': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test5.png}} &
\subfloat['6': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test6.png}} & 
\subfloat['7': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test7.png}} & 
\subfloat['8': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test8.png}} &
\subfloat['9': 100\%]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test9.png}} \\
\end{tabular}
...
\end{tabular}
\caption[Deep visualization of VGG16 output]{Deep visualization of the output layer for a selection of 8 output classes of the VGG16 network. The visualizations are created using a learning rate of 2500 for 1000 iterations. The hyperparameter settings correspond to the third row of \textbf{Table \ref{tab:reg_hyperparams}}.}
