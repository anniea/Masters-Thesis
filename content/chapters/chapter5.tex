...
\end{tabular}
\caption[Visualization images for MNIST]{The images to be used as visualization images for the MNIST network.}
\end{center}
\end{figure}
...
\begin{center}
\begin{tabular}{c}
\subfloat{\includegraphics[width=0.5\textwidth]{fig/results/input_vgg/girlonbike.JPEG}} \\
\subfloat{\includegraphics[width=0.5\textwidth]{fig/results/input_vgg/biking.JPEG}} \\
\subfloat{\includegraphics[width=0.5\textwidth]{fig/results/input_vgg/girl.JPEG}} \\
\end{tabular}
\caption[Visualization images for VGG16]{The images to be used as visualization images for the VGG16 network.}
\end{center}
\end{figure}
...
\subfloat[Input layer]{\makebox[1in][c]{\includegraphics[width = 0.4in]{fig/results/input_mnist/test0.png}}}\endgroup \\
\subfloat[Convolution layer 1]{\frame{\includegraphics[width=0.6\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_conv2d_1.png}}} \\
\subfloat[Convolution layer 2]{\frame{\includegraphics[width=0.6\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_conv2d_2.png}}} \\
\subfloat[Max pooling layer]{\frame{\includegraphics[width=0.5\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_max_pooling2d_1.png}}} \\
\subfloat[Fully connected layer 1]{\frame{\includegraphics[width=\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_dense_1.png}}} \\
\subfloat[Fully connected layer 2]{\frame{\includegraphics[width=\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_dense_2.png}}} \\
\subfloat[Fully connected layer 3 (output layer)]{\frame{\includegraphics[width=0.3\textwidth]{fig/results/layeract_mnist/all_layers/layer_act_mnist_0_10_dense_3.png}}} \\
\end{tabular}
...
\begin{center}
\begin{tabular}{c}
\subfloat[0]{\frame{\includegraphics[width=0.6\textwidth]{fig/results/layeract_mnist/layer_act_mnist_0_0_conv2d_2.png}}} \\
\subfloat[5]{\frame{\includegraphics[width=0.6\textwidth]{fig/results/layeract_mnist/layer_act_mnist_0_5_conv2d_2.png}}} \\
\subfloat[10]{\frame{\includegraphics[width=0.6\textwidth]{fig/results/layeract_mnist/layer_act_mnist_0_10_conv2d_2.png}}} \\
\end{tabular}
\caption[Layer activations for all MNIST layers]{Caption.}
\end{center}
\end{figure}
...
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_0_6.png}} &
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_0_8.png}} &
...
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_1_6.png}} &
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_1_8.png}} &
...
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_2_6.png}} &
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_2_8.png}} &
...
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_3_6.png}} &
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_3_8.png}} &
...
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_4_6.png}} &
\subfloat{\includegraphics[width = 0.5in]{fig/results/saliency_mnist/saliency_mnist_4_8.png}} &
...
\begin{center}
\begin{tabular}{ccccc}
\subfloat[Input image]{\includegraphics[width = 0.5in]{fig/results/input_mnist/test0.png}} & 
\subfloat[Feature map 1]{\includegraphics[width = 0.5in]{fig/results/deconv_mnist/deconvolution_mnist_0_10_max_pooling2d_1_1.png}} & 
\subfloat[Feature map 22]{\includegraphics[width = 0.5in]{fig/results/deconv_mnist/deconvolution_mnist_0_10_max_pooling2d_1_22.png}} &
\subfloat[Feature map 25]{\includegraphics[width = 0.5in]{fig/results/deconv_mnist/deconvolution_mnist_0_10_max_pooling2d_1_25.png}} & 
\subfloat[Feature map 28]{\includegraphics[width = 0.5in]{fig/results/deconv_mnist/deconvolution_mnist_0_10_max_pooling2d_1_28.png}} \\
\end{tabular}
\caption[Deconv MNIST]{Caption.}
\end{center}
\end{figure}
...
\end{tabular}
\caption[Layer activations for VGG16]{Caption.}
\end{center}
\end{figure}
