...
Without regularization, the input image has a tendency to contain high frequency information. Induced by the gradient ascent for its ability to cause high activations in the network, this high frequency information impedes the image's visualization qualities. 
