...
\hline
\multicolumn{5}{|c|}{Case Study Network Results} \\ \hline
...
\end{tabular}
\end{center}
\caption[Case study network results]{Describe results a bit}
