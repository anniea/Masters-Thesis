...
To present the results of the visualization tool, we will make use of well known \acrshortpl{ann}, and show the visualizations produced at various stages of training. As the results are images, we will need to perform quantitative data analysis on these images. The goal will be to identify connections between the visualizations and the behaviour of the networks, both in terms of why they may perform well and why they may struggle. \\
