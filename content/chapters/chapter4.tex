...
% kan skrive mer om bokehs sever og at det er veldig bra for modifiability
...
% maybe another figure of the application in more detail, e.g. with folders etc. or we can show the top folder structure.
...
% can add more specifics here, either in a subsubsection or in a new subsection.
