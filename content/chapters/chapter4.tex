...
% In particular, we adopt the 16 weight layer network from configuration D. The weight values of this configuration, as computed in Parki et al. \cite{deep-face-rec}, has been made available\footnote{http://www.robots.ox.ac.uk/~vgg/software/vgg_face/} and converted to use with the Keras framework\footnote{https://github.com/rcmalli/keras-vggface}.
